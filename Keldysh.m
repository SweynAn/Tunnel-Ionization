...
%Returns the Keldysh Parameter given the driving wavelength in nm, zero-field ionization
%energy in eV, and the electric field intensity in Watts per square cm.

function [ gamma ] = Keldysh(ion,drivingWavelength ,fieldIntensity )
...
gamma=(ionizationPotential/(2*9.337*10^(-20)*(fieldIntensity)*(drivingWavelength)^2))^(1/2);
